    ...
    <div className="main-page">
      ...
      <div className="main-content">
        ...
        <aside className="side-menu">
          ...
          <div className="side-menu-item" onClick={() => navigate("/invoice")}>
            <span className="side-icon">🧾</span>
            <span>세금계산서 등록</span>
          </div>
          ...
          <div className="side-image-box">
            <img src="/images/login_left_illustration.png" alt="SmartTax" />
          </div>
        </aside>
        ...
        <main className="main-body">
          ...
          <section className="main-hero">
            <div className="hero-text">
              <p className="hero-small">S M A R T T A X</p>
          ...
          <div className="main-footer">
            <span className="footer-lightbulb">💡</span>

            <span>SmartTax는 쉽고 편리한 세금계산서 관리를 도와드립니다.</span>

            <span className="footer-right">SmartTax</span>
          </div>
        </main>
      </div>
    </div>
